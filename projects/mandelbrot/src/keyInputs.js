export class KeyInputs {
	...
	getKeyPressed(keyName) {
		if (this.releasedKeys[this.keyMap[keyName]] && this.keys[this.keyMap[keyName]]) {
			this.releasedKeys[this.keyMap[keyName]] = false;
			return true;
		}
		return false;
	}
